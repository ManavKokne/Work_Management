  ...
  return `
    <div class="sr-wrap">
      ...
      <div class="sr-head">
        ...
        <div style="font-weight:500;">No. <strong>${buildFormValue(data.taskId)}</strong></div>
      </div>
      ...
      <div class="sr-info-grid" style="grid-template-columns:100px 1fr;">
        <div>Observation</div>
        <div>${buildFormValue(data.problemReported)}</div>
      </div>

      <div class="sr-observe">
        <div style="margin-bottom:4px;font-weight:700;">Work Done</div>
        <div>${buildFormValue(data.workDone)}</div>
      </div>
